...
{
    cout << "ESCPOSPrinter::cutPaper " << endl;
...
{
    cout << "ESCPOSPrinter::printBarcode: " << code.toStdString().c_str() <<
         ":"<<type <<":"<<width <<":"<<height <<":"<<pos<<":"<<font<< endl;
...
unsigned ESCPOSPrinter::printQRCode(QString code, unsigned errCorrect,
                                    unsigned moduleSize)
{
    cout << "ESCPOSPrinter::printQRCode: " << code.toStdString().c_str() <<
         ":"<<errCorrect <<":"<<moduleSize << endl;
